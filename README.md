...
## ✨ Breathtaking Premium Features v2.6.0
- **📁 Custom Interview Templates**: Load custom mock interview personas and prompt guidelines directly from local JSON files.
